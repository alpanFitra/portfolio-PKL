      ...
      <nav class="mt-2">
        ...
        <li class="nav-header">MAIN MENU</li>
          ...
          <li class="nav-item has-treeview">
            ...
            <p>Modul Dokumen <i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
            <?php
              $cek=$this->model_app->umenu_akses("listberita",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/listberita'><i class='far fa-circle nav-icon text-success'></i> <p>Dokumen</p></a></li>";
              }

              $cek=$this->model_app->umenu_akses("kategoriberita",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/kategoriberita'><i class='far fa-circle nav-icon text-success'></i> <p>Kategori Dokumen</p></a></li>";
              }

              $cek=$this->model_app->umenu_akses("tagberita",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/tagberita'><i class='far fa-circle nav-icon text-success'></i> <p>Tag Dokumen</p></a></li>";
              }

              $cek=$this->model_app->umenu_akses("komentarberita",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/komentarberita'><i class='far fa-circle nav-icon text-success'></i> <p>Komentar Dokumen</p></a></li>";
              }
              ...
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/album'><i class='far fa-circle nav-icon text-success'></i> <p>Dokumen Foto</p></a></li>";
              }

              $cek=$this->model_app->umenu_akses("gallery",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/gallery'><i class='far fa-circle nav-icon text-success'></i> <p>Gallery Dokumen Foto</p></a></li>";
              }
            ?>
            </ul>
          </li>
          ...
          <?php 
          $data = array('aktif'=>'Y');
          $templateaktif = $this->model_app->view_where('templates',$data)->row_array(); 
          ?>
          <li class="nav-header">USER MENU</li>
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
            <i class="nav-icon fas fa-users-cog"></i>
            <p><?=$templateaktif['judul']?><i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
            <?php
              $cek=$this->model_app->umenu_akses("manajemenuser",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/dataproduk'><i class='far fa-circle nav-icon text-success'></i> <p>Data Produk</p></a></li>";
              }

              $cek=$this->model_app->umenu_akses("manajemenmodul",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/dataclient'><i class='far fa-circle nav-icon text-success'></i> <p>Data Client</p></a></li>";
              }

              $cek=$this->model_app->umenu_akses("manajemenmodul",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/datafitur'><i class='far fa-circle nav-icon text-success'></i> <p>Data Fitur</p></a></li>";
              }
              
              $cek=$this->model_app->umenu_akses("manajemenmodul",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/datadesk'><i class='far fa-circle nav-icon text-success'></i> <p>Data Deskripsi</p></a></li>";
              }

              $cek=$this->model_app->umenu_akses("manajemenmodul",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/dataapp'><i class='far fa-circle nav-icon text-success'></i> <p>Data Aplikasi</p></a></li>";
              }

              $cek=$this->model_app->umenu_akses("manajemenmodul",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/dataevent'><i class='far fa-circle nav-icon text-success'></i> <p>Data Event</p></a></li>";
              }
              $cek=$this->model_app->umenu_akses("manajemenmodul",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/datakontak'><i class='far fa-circle nav-icon text-success'></i> <p>Data Kontak</p></a></li>";
              }
            ?>
            </ul>
          </li>
