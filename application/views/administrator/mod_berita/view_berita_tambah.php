    ...
    echo "<div class='card'>
          ...
          echo "<table class='table table-sm table-borderless'>
                  <tbody>
                    ...
                    <tr><th scope='row'>Dokumen Utama</th>           <td><input type='radio' name='g' value='Y'> Ya &nbsp; <input type='radio' name='g' value='N' checked> Tidak</td></tr>
                    <tr><th scope='row'>Isi Dokumen</th>             <td><textarea id='editor1' class='form-control' name='h' style='height:260px' required></textarea></td></tr>
