		...
		<div class="content-block main right">
			...
			<div class="block">
				<div class="block-title">
					<a href="<?php echo base_url(); ?>berita/indeks_berita" class="right">+ Indexs</a>
					<h2>Karena Anda Kami Ada</h2>
				</div>
				<div class="block-content">
					<ul class="article-block">
						<?php 
							$no = 1;
							$hot = $this->model_utama->view_join_two('berita','users','kategori','username','id_kategori',array('status' => 'Y','kategori.id_kategori' => 5),'tanggal','DESC',0,5);
			...
			<div class="block">
				...
				<div class="block-content">
					<ul class="article-block">
						<?php 
							$pilihan = $this->model_utama->view_join_two('berita','users','kategori','username','id_kategori',array('berita.aktif' => 'Y','berita.status' => 'Y','kategori.id_kategori' => 6),'tanggal','DESC',0,3);
