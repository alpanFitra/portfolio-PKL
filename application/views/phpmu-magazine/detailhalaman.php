						...
						<div class="paragraph-row">
							<div class="column12">
								...
								<?php 
									...
									if ($rows['isi_halaman']==''){
										if ($rows['file']!=''){
											echo "<div id='filePDF' class='span9 fileview' style='background: transparent url(' assets='' admin='' layout='' img='' loading.gif')'=''>
			                            	<div class='addthis_sharing_toolbox'></div>
			                                <object data='" . base_url() . "asset/foto_statis/$rows[file]#toolbar=0' type='application/pdf' width='100%' height='600px' onload='loaded()' onerror='notfoundpdf()' internalinstanceid='21'>
			                                </object>
			                            	</div>";
