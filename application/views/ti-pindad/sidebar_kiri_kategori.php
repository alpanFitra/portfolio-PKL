...
<div class="block">
	...
	if ($this->uri->segment(1)=='video'){
		...
		echo "<h2 class='list-title' style='color: #2277c6; border-bottom: 2px solid #2277c6;''>$r[nama_kategori]</h2>
		...
		echo "<h2 class='list-title' style='color:#2277c6; border-bottom: 2px solid #2277c6;''>Populer</h2>
		<ul class='article-block'>";
