...
<!--<div class="block">
	...
	<ul class="article-list">
		<?php
		  /* $banner = $this->model_utama->view_ordering_limit('banner','id_banner','ASC',0,3);
...
<div class="block">
  <h2 style='color:#000; border-bottom: 2px solid #000;' class="list-title">Klien</h2>
...
<div class="block">
	<?php $rh = $this->model_utama->view_where('kategori',array('sidebar' => 1))->row_array(); ?>
	<h2 class="list-title" style="color: #c42b20;border-bottom: 2px solid #c42b20;"><?php echo "$rh[nama_kategori]"; ?></h2>
	<ul class="article-block">
		<?php 
			$kategori3 = $this->model_utama->view_join_two('berita','users','kategori','username','id_kategori',array('berita.id_kategori' => $rh['id_kategori'],'berita.status' => 'Y'),'id_berita','DESC',0,3);			
...
<div class="block">
	<?php $rhx = $this->model_utama->view_where('kategori',array('sidebar' => 2))->row_array(); ?>
	<h2 class="list-title" style="color: #2277c6;border-bottom: 2px solid #2277c6;"><?php echo "$rhx[nama_kategori]"; ?></h2>
	<ul class="article-block">
		<?php 
			$kategori4 = $this->model_utama->view_join_two('berita','users','kategori','username','id_kategori',array('berita.id_kategori' => $rhx['id_kategori'],'berita.status' => 'Y'),'id_berita','DESC',0,3);			
...
<div class="block">
	<?php $rha = $this->model_utama->view_where('kategori',array('sidebar' => 3))->row_array(); ?>
	<h2 class="list-title" style="color:green; border-bottom: 2px solid green;"><?php echo "$rha[nama_kategori]"; ?></h2>
	<ul class="article-block">
		<?php 
			$kategori4 = $this->model_utama->view_join_two('berita','users','kategori','username','id_kategori',array('berita.id_kategori' => $rha['id_kategori'],'berita.status' => 'Y'),'id_berita','DESC',0,3);			
			foreach ($kategori4->result_array() as $r2x) {
			$total_komentar = $this->model_utama->view_where('komentar',array('id_berita' => $r2x['id_berita']))->num_rows();
				echo "<li>
						<div class='article-photo'>";
...
<div class="block">
	<?php $rha = $this->model_utama->view_where('kategori',array('sidebar' => 4))->row_array(); ?>
	<h2 class="list-title" style="color:green; border-bottom: 2px solid green;"><?php echo "$rha[nama_kategori]"; ?></h2>
	<ul class="article-block">
		<?php 
			$kategori4 = $this->model_utama->view_join_two('berita','users','kategori','username','id_kategori',array('berita.id_kategori' => $rha['id_kategori'],'berita.status' => 'Y'),'id_berita','DESC',0,3);			
